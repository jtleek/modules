...
```{r nucData,fig.height=4,fig.width=4,cache=TRUE}
...
```{r irisData,fig.height=3,fig.width=3,cache=TRUE}
data(iris)
head(iris)
```
...
```{r bagTree, dependson="irisData",fig.height=4,fig.width=4,cache=TRUE}
library(ipred)
...
```{r predForest, dependson="forestIris",fig.height=4,fig.width=4,cache=TRUE}
