...
```{r bootEx,fig.height=4,fig.width=4,cache=TRUE}
...
```{r bootNuc,fig.height=4,fig.width=4,cache=TRUE}
...
```{r nukeLm, dependson="bootNuc",fig.height=3.3,fig.width=8,cache=TRUE}
par(mfrow=c(1,3))
for(i in 1:3){
...
```{r nucRes, dependson="nukeLm",fig.height=3.5,fig.width=4,cache=TRUE}
...
```{r nullBoot, dependson="nukeLm",fig.height=4,fig.width=4, cache=TRUE}
