...
<img class=center src=../../assets/img/08_PredictionAndMachineLearning/makers.png height=450>
...
```{r basicModels, dependson="generateData",fig.height=4,fig.width=4,cache=TRUE}
library(tree)
...
```{r blend1, dependson="medley", cache=TRUE}
