...
## Iris petal widths/sepal width
```{r createTree, dependson="iris", cache=TRUE}
...
```{r carsData,fig.height=3,fig.width=3, cache=TRUE}
...
```{r treeCars, dependson="carsData",fig.height=4,fig.width=4, cache=TRUE}
...
```{r , dependson="treeCars",fig.height=3,fig.width=8}
par(mfrow=c(1,2))
